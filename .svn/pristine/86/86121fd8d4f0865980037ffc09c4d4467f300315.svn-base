...
?>
<p class="sub_judul">5.3 Pelaksanaan Proses Pembelajaran</p>
<p>
...
<p>Jelaskan mekanisme penyusunan materi kuliah dan monitoring perkuliahan antara lain kehadiran dosen dan mahasiswa, serta materi kuliah.</p>
...
<button class="btn">Download Lampiran</button>
<?
}
?>