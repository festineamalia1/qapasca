...
$this->breadcrumbs=array(
	'Manajemen Data Evaluasi Lulusan',
);
?>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/evaluasilulusan/admin" class="d_tab" data-toggle="tab">Evaluasi</a></li>
