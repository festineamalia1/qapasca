...
class CapaianDosen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, nama_dosen, prestasi, waktu, tingkat','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi', 'numerical', 'integerOnly'=>true),
			array('nama_dosen', 'length', 'max'=>200),
			array('waktu', 'length', 'max'=>4),
			array('tingkat', 'length', 'max'=>20),
