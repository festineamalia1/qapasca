...
class TugasBljDosen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, nama_dosen, pendidikan_lanjut, bidang_studi, PT, negara, th_mulai_studi','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'pendidikan_lanjut' => 'Jenjang Pendidikan Lanjut',
			'bidang_studi' => 'Bidang Studi',
			'PT' => 'Perguruan Tinggi',
			'negara' => 'Negara',
			'th_mulai_studi' => 'Tahun Mulai Studi',
