...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'status_mk',array('lama'=>'Lama','baru'=>'Baru','hapus'=>'Hapus','mk berubah nama'=>'MK Berubah Nama','mk berubah nama dan status'=>'MK Berubah Nama dan Status','mk berubah status'=>'MK Berubah Status'),array('prompt' => 'Pilih Status MK')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'alasan_peninjauan',array('class'=>'input-xxlarge','size'=>60,'maxlength'=>100)); ?>
