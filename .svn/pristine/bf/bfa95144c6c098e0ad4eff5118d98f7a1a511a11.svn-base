...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'bobot_jenis_sks'); ?>
		<?php echo $form->textField($model,'bobot_jenis_sks',array('size'=>5,'maxlength'=>5)); ?>
		<?php echo $form->error($model,'bobot_jenis_sks'); ?>
	</div>
