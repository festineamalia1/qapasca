...
<h1>4.4 Dosen Tidak Tetap</h1>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	<li class="list_tab active"><a href="#tab1" class="a_tab" data-toggle="tab">Data Dosen</a></li>
		    	<li class="list_tab "><a href="#tab2" class="b_tab" data-toggle="tab">Aktivitas Dosen Setahun</a></li>

		  	</ul>
		  	<div class="tab-content">
		    	<div class="tab-pane activeTampil">
		    		<!-- Start Tab 1 -->
		      		<div class="row-fluid">
			    ...
			    return false;
			  	...
			  	// tab 2
					  $(".getdata_dosentidaktetap_setahun").click(function()
					  	{
					  		var dataserialized = $('#form_dosentidaktetap_aktivitas').serialize();
					  		// $("#data").hide();
