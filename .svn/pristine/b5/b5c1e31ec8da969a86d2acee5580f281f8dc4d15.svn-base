...
class Kerjasama extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, nama_instansi, jenis_kegiatan, th_mulai, th_akhir, manfaat, jenis_kerjasama, sumber_data', 'required'),
			array('id_prodi, id_administrasi, id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('nama_instansi', 'length', 'max'=>50),
			array('jenis_kegiatan, manfaat, sumber_data, lampiran', 'length', 'max'=>100),
			array('th_mulai, th_akhir', 'length', 'max'=>4),
			array('jenis_kerjasama', 'length', 'max'=>11),
			//tambahan
