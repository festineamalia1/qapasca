...
$this->breadcrumbs=array(
	'Kegiatan Tenaga Ahli Luar PT'=>array('index'),
	'Manajemen',
);
...
$('.search-form form').submit(function(){
	$('#kegiatan-tenaga-ahli-luarpt-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manajemen Data Kegiatan Tenaga Ahli Luar PT</h1>
<?
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'kegiatan-tenaga-ahli-luarpt-grid',
