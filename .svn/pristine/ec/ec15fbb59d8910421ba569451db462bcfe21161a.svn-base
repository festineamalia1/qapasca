...
class Layanan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi,id_administrasi, kegiatan_BK, pelaksanaan_BK, hasil_BK, kegiatan_minat, pelaksanaan_minat, hasil_minat, kegiatan_softskill, pelaksanaan_softskill, 
				hasil_softskill, kegiatan_beasiswa, pelaksanaan_beasiswa, hasil_beasiswa, kegiatan_kesehatan, pelaksanaan_kesehatan, hasil_kesehatan','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
