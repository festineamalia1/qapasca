...
$this->breadcrumbs=array(
	'Manajemen Data Mahasiswa Reguler',
);
?>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/mhsreguler/admin" class="a_tab" data-toggle="tab">Mahasiswa Reguler</a></li>
