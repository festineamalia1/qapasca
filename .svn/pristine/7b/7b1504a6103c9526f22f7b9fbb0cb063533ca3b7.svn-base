...
$this->breadcrumbs=array(
	'Mekanisme Penyusunan Mata Kuliah'=>array('index'),
	'Manajemen',
);
...
$('.search-form form').submit(function(){
	$('#mekanisme-penyusunan-mk-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manajemen Data Mekanisme Penyusunan Mata Kuliah</h1>
<?
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'mekanisme-penyusunan-mk-grid',
