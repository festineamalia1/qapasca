...
<?php
	// $model=new VisiMisi;
?>
<h1>Peninjauan Kurikulum dalam 5 Tahun Terakhir </h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_peninjauan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_peninjauan"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_peninjauan").click(function()
  	{
  		var dataserialized = $('#form_peninjauan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdatapeninjauan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_peninjauan").trigger('click');
