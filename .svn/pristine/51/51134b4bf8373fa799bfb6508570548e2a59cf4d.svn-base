...
class PenelitianDosentetapPs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, sumber_pembiayaan, waktu_TS,waktu_TS2,waktu_TS1,status, mhs_terlibat', 'required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, jum_mhs_ambil_ta, jum_mhs_penelitian, id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('sumber_pembiayaan', 'length', 'max'=>100),
			array('detail_sumber_biaya', 'length', 'max'=>400),
			array('waktu_TS2, waktu_TS1, waktu_TS', 'length', 'max'=>4),
	...
	public function attributeLabels()
	{
		return array(
			...
			'mhs_terlibat' => 'Keterlibatan Mahasiswa',
			'jum_mhs_ambil_ta' => 'Jumlah Mahasiswa Ambil TA',
			'jum_mhs_penelitian' => 'Jumlah Mahasiswa Penelitian',
			'wujud_mhs_pkm' => 'Wujud Mahasiswa Pkm',
	...
	public function search()
	{
		...
		$criteria->compare('sumber_pembiayaan',$this->sumber_pembiayaan);
