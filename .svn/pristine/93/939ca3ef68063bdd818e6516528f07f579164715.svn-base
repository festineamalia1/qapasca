...
class BimbinganTa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, jml_mhs, sumber_data', 'required'),
			...
			array('th_akademik_search, nama_prodi_search,id_bimbingan_TA, id_prodi, id_administrasi, id_dosen, jml_mhs, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
