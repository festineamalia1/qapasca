...
class HimpunanAlumni extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, aktivitas, hasil_kegiatan, jenis_kegiatan, sumbangan_dana, sumbangan_fasilitas, libat_kegiatan,
			 kembang_jejaring, sedia_fasilitas','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'libat_kegiatan' => 'Keterlibatan dalam kegiatan',
			'kembang_jejaring' => 'Pengembangan jejaring',
			'sedia_fasilitas' => 'Penyediaan fasilitas',
