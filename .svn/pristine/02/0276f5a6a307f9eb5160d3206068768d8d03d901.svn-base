...
/* @var $data FDanaMasyarakat */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_dana_kegiatan')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_dana_kegiatan), array('view', 'id'=>$data->id_dana_kegiatan)); ?>
	<br />
