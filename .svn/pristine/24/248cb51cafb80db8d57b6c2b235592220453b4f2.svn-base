...
$this->breadcrumbs=array(
	'Manajemen Data Tanggapan Pihak Pengguna Lulusan',
);
?>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/detailevaluasilulusan/admin" class="d_tab" data-toggle="tab">Tanggapan Pihak Pengguna Lulusan</a></li>
		    	<li class="list_tab "><a href="<?=Yii::app()->getBaseUrl(true)?>/himpunanalumni/admin" class="d_tab" data-toggle="tab">Alumni</a></li>
		  	</ul>
		</div>
	</div>
</div>
