...
<div class="row-fluid">
	<div class="span12">
		<form class="form-inline" method="post" id="form_kerjasama">		    
		    <label class="control-label" for="">Statistik Kerjasama Jurursan Tahun</label>
		    ...
		    <button type="button" class="btn btn-primary get_kerjasama"><i class="icon-arrow-right icon-white"></i> Proses</button>
		</form>
		...
		<div id="data_mhs_reg" class="data">	
			<?php $this->renderPartial('pages/v_gr_kerjasama', array()); ?>
		</div>
	</div>
</div>
<hr>
...
<div class="row-fluid">
	<div class="span12" style="text-align:center;">
		...
		<a href="<?=Yii::app()->getBaseUrl(true)?>/site/dashboard_nonreg" title="Dashboard Mahasiswa Non Reguler">
			<div class="box_menu">
				<img src="<?=Yii::app()->getBaseUrl(true)?>/file/MenuManajemen/VisiMisi.gif" style="float:left;width:100%;"> <br>
				<h5 class="judul_menu">Grafik Mahasiswa Non Reguler</h5>
			</div>
		</a>
...
$(function(){
  $(".get_kerjasama").click(function()
  	{
  		var dataserialized = $('#form_kerjasama').serialize();
  		$.ajax({
  			type: 'POST',
  			url:"GrafikKerjasama",
  			data: dataserialized,
