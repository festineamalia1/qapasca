...
class SistemInformasi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, media, kegunaan', 'required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'media' => 'Media',
			'kegunaan' => 'Kegunaan',
			'F_rencana_pengembangan_si' => 'Rencana Pengembangan Sistem Informasi',
