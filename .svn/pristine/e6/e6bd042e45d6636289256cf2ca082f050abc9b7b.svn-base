...
<?php
	// $model=new VisiMisi;
?>
<h1>Pelaksanaan Proses Pembelajaran</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_pembelajaran">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_pembelajaran"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_pembelajaran").click(function()
  	{
  		var dataserialized = $('#form_pembelajaran').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdatapembelajaran",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_pembelajaran").trigger('click');
