...
<!-- end tambahan -->
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'jenis_tenaga',array('peneliti'=>'Peneliti','pustakawan'=>'Pustakawan','laboran'=>'Laboran','teknisi'=>'Teknisi','analisis'=>'Analisis','operator'=>'Operator','programmer'=>'Programmer'),array('prompt' => 'Pilih Jenis Tenaga')); ?>
