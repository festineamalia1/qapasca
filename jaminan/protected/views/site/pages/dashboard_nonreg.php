...
<div class="row-fluid">
	<div class="span12">
		<form class="form-inline" method="post" id="form_mhs_reg">		    
		    <label class="control-label" for="">Statistik Mahasiswa Reguler Tahun</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_mhs_reg"><i class="icon-arrow-right icon-white"></i> Proses</button>
		</form>
		...
		<div id="data_mhs_reg" class="data">	
			<?php $this->renderPartial('pages/v_gr_mhs_nonreg', array()); ?>
		</div>
	</div>
</div>
<hr>
...
<div class="row-fluid">
	<div class="span12" style="text-align:center;">
		...
		<a href="<?=Yii::app()->getBaseUrl(true)?>/site/dashboard_nonreg" title="Grafik Mahasiswa Non Reguler">
			<div class="box_menu">
				<img src="<?=Yii::app()->getBaseUrl(true)?>/file/MenuManajemen/VisiMisi.gif" style="float:left;width:100%;"> <br>
...
$(function(){
  $(".getdata_mhs_reg").click(function()
  	{
  		var dataserialized = $('#form_mhs_reg').serialize();
  		$.ajax({
  			type: 'POST',
  			url:"GrafikMhsNonReg",
  			data: dataserialized,
