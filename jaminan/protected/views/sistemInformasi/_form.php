...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'media',array('si'=>'Sistem Informasi','email'=>'Email','surat'=>'Surat','fax'=>'Fax','sms'=>'SMS','sosmed'=>'Sosial Media','papan'=>'Papan','lainnya'=>'Lainnya'),array('prompt' => 'Pilih Jenis Media')); ?>
	</div>
