						...
						<div class="span12" style="padding:20px;">
							<form class="form-inline" method="post" id="form_kerjasama_dalam">
							   <label class="control-label" for="">Jurusan</label>
							    ...
							    <button type="button" class="btn btn-primary getdata_kerjasama_dalam"><i class="icon-arrow-right icon-white"></i> Tampil</button>
							</form>
						</div>
					</div>
					<!-- END -->
						...
						<div class="span12" style="padding:20px;">
							<form class="form-inline" method="post" id="form_kerjasama_luar">
							   <label class="control-label" for="">Jurusan</label>
							    ...
							    <button type="button" class="btn btn-primary getdata_kerjasama_luar"><i class="icon-arrow-right icon-white"></i> Tampil</button>
							</form>
						</div>
					</div>
					<!-- END -->
