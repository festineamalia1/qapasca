...
<!-- tambahan -->
	<?php echo "<b>Sebutkan keikutsertaan dosen tetap dalam organisasi keilmuan atau organisasi profesi.</b>";?><br><br>
	<?
...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nama_organisasi'); ?>
		<?php echo $form->error($model,'nama_organisasi'); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'tingkat',array('lokal'=>'Lokal','nasional'=>'Nasional','internasional'=>'Internasional'),array('prompt' => 'Pilih Tingkat Organisasi')); ?>
	</div>
