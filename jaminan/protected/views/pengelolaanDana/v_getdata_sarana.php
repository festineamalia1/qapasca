...
<?php
	// $model=new VisiMisi;
?>
<h1>Sarana Pelaksanaan Kegiatan Akademik</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_sarana">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_sarana"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_sarana").click(function()
  	{
  		var dataserialized = $('#form_sarana').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdatasarana",
