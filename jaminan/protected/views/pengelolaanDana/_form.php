...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'jenis_dana',array('size'=>150,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'jumlah_dana_TS2'); ?>
		<?php echo $form->error($model,'jumlah_dana_TS2'); ?>
		<?php echo $form->textField($model,'jumlah_dana_TS2',array('size'=>150,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'jumlah_dana_TS1'); ?>
		<?php echo $form->error($model,'jumlah_dana_TS1'); ?>
		<?php echo $form->textField($model,'jumlah_dana_TS1',array('size'=>150,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'jumlah_dana_TS'); ?>
		<?php echo $form->error($model,'jumlah_dana_TS'); ?>
		<?php echo $form->textField($model,'jumlah_dana_TS',array('size'=>150,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'sumber_data'); ?>
		<?php echo $form->error($model,'sumber_data'); ?>
		<?php echo $form->textField($model,'sumber_data',array('size'=>150,'maxlength'=>150)); ?>
	</div>
