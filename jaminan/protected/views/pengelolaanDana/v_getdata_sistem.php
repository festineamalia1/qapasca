...
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_sistem">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_sistem"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_sistem").click(function()
  	{
  		var dataserialized = $('#form_sistem').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdatasistem",
