...
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_prasarana">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_prasarana"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_prasarana").click(function()
  	{
  		var dataserialized = $('#form_prasarana').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdataprasarana",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_prasarana").trigger('click');
