...
<p style="padding-left:25px;margin-top:-10px">Jelaskan mekanisme penyusunan materi kuliah dan monitoring perkuliahan antara lain kehadiran dosen dan mahasiswa, serta materi kuliah.</p>
<?php
if(empty($data)){
	?>
