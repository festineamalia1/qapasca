...
class AktivitasDosenSetahun extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, nama_dosen, bidang_keahlian, kode_mk, nama_mk, jum_kelas, jum_rencana_pertemuan, jum_pertemuan_terlaksana,
			 status_bidang','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, jum_kelas, jum_rencana_pertemuan, jum_pertemuan_terlaksana', 'numerical', 'integerOnly'=>true),
			array('nama_dosen, bidang_keahlian, nama_mk', 'length', 'max'=>300),
	...
	public function attributeLabels()
	{
		return array(
			...
			'jum_kelas' => 'Jumlah Kelas',
			'jum_rencana_pertemuan' => 'Jumlah Rencana Pertemuan',
			'jum_pertemuan_terlaksana' => 'Jumlah Pertemuan Terlaksana',
