...
class VisiMisi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, mekanisme, visi, misi, tujuan, sasaran, strategi, sosialisasi, id_administrasi', 'required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
