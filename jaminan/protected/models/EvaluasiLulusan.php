...
class EvaluasiLulusan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, studi_pelacakan, metode, proses, mekanisme_kegiatan, tindak_lanjut, hasil','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
	...
	public function relations()
	{
		...
		return array(
			...
			// 'relasi_detail' => array(self::HAS_MANY, 'DetailEvaluasiLulusan', 'id_evaluasi'),
		);
		// end tambahan
	}
