...
class BimbinganAkademik extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, jml_mhs_bim, rata_pertemuan','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			...
			array('nama_dosen_search,th_akademik_search, nama_prodi_search,id_bimbingan, id_prodi, id_administrasi, id_dosen, jml_mhs_bim, rata_pertemuan, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_dosen' => 'Dosen',
			'jml_mhs_bim' => 'Jumlah Mahasiswa Bimbingan',
			'rata_pertemuan' => 'Rata - rata Pertemuan',
