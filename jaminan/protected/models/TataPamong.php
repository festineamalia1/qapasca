...
class TataPamong extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			// 'umpan_balik_mhs' => 'Umpan Balik Mahasiswa',
			// 'tindak_lanjut_mhs' => 'Tindak Lanjut Mahasiswa',
			...
			// 'animo_calon_mhs' => 'Animo Calon Mahasiswa',
			...
			'lampiran' => 'Lampiran / Chart File (Format nama file harus : TataPamong_tahunakreditasi (.zip/.jpg / .jpeg) contoh TataPamong_2012.zip)',
