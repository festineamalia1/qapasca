...
class Prasarana extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, ruang_kerja, jml_ruang, luasm2,', 'required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, jml_ruang, luasm2, id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('ruang_kerja', 'length', 'max'=>10),
	...
	public function attributeLabels()
	{
		return array(
			...
			'ruang_kerja' => 'Ruang Kerja Dosen',
			'jml_ruang' => 'Jumlah Ruang',
			'luasm2' => 'Jumlah Luas (m2)',
			'F_uraian_aspek' => 'Uraian Aspek',
			'F_uraian_penilaian' => 'Uraian Penilaian',
