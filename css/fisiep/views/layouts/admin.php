...
<body>
    <div class="container-fluid" style="margin:0;padding:0;">
        <div class="row-fluid">
            <div class="span12 header" style="height:50px !important;">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="menu" style="background:none;">
                                <!-- <h2 style="width:20%;float:left;color:#FFF;">QA Fisipol</h2> -->
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12 field_content">
                <div class="row-fluid">
                    <div class="span12 content-after-sidebar">
