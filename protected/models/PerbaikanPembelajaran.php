...
class PerbaikanPembelajaran extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, materi_tindakan, materi_hasil, metode_tindakan, metode_hasil, teknologi_tindakan, teknologi_hasil, evaluasi_tindakan, evaluasi_hasil, lainnya, sumber_data', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'materi_tindakan' => 'Materi Tindakan',
