...
class PeninjauanKurikulum extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, kode_mk, status_mk, perubahan_silabus, perubahan_buku_ajar, alasan_peninjauan, pengusul, berlaku_mulai, sumber_data', 'required'),
			array('id_prodi, id_administrasi', 'numerical', 'integerOnly'=>true),
			array('kode_mk', 'length', 'max'=>10),
			array('status_mk', 'length', 'max'=>5),
