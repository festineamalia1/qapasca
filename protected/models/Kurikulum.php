...
class Kurikulum extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_mk_kurikulum, kompetensi_utama, kompetensi_pendukung, kompetensi_lain, sumber_data', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'kompetensi_utama' => 'Kompetensi Utama',
			'kompetensi_pendukung' => 'Kompetensi Pendukung',
			'kompetensi_lain' => 'Kompetensi Lain',
