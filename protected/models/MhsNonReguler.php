...
class MhsNonReguler extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, th_akademik, daya_tampung, jml_ikut_seleksi, jml_lulus_seleksi, jml_maba_nonreg, jml_transfer, tot_mhs_nonreg, tot_transfer, sumber_data', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'jml_ikut_seleksi' => 'Jml Ikut Seleksi',
			'jml_lulus_seleksi' => 'Jml Lulus Seleksi',
			'jml_maba_nonreg' => 'Jml Maba Nonreg',
			'jml_transfer' => 'Jml Transfer',
			'tot_mhs_nonreg' => 'Tot Mhs Nonreg',
			'tot_transfer' => 'Tot Transfer',
