...
class MhsReguler extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, thn_akademik, daya_tampung, mhs_ikut_seleksi, mhs_lulus_seleksi, maba_bkn_transfer, maba_transfer, total_mhs_bkn_transfer, total_mhs_transfer, jumlah_lulus_bkn_transfer, jumlah_lulus_transfer, ipk_min_lulusan_reguler, ipk_rata2_lulusan_reguler, ipk_maks_lulusan_reguler, persen_ipk275, persen_ipk275_350, persen_ipk350', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'mhs_ikut_seleksi' => 'Mhs Ikut Seleksi',
			'mhs_lulus_seleksi' => 'Mhs Lulus Seleksi',
			'maba_bkn_transfer' => 'Maba Bkn Transfer',
			'maba_transfer' => 'Maba Transfer',
			'total_mhs_bkn_transfer' => 'Total Mhs Bkn Transfer',
			'total_mhs_transfer' => 'Total Mhs Transfer',
			'jumlah_lulus_bkn_transfer' => 'Jumlah Lulus Bkn Transfer',
			'jumlah_lulus_transfer' => 'Jumlah Lulus Transfer',
			'ipk_min_lulusan_reguler' => 'Ipk Min Lulusan Reguler',
			'ipk_rata2_lulusan_reguler' => 'Ipk Rata2 Lulusan Reguler',
			'ipk_maks_lulusan_reguler' => 'Ipk Maks Lulusan Reguler',
			'persen_ipk275' => 'Persen Ipk275',
			'persen_ipk275_350' => 'Persen Ipk275 350',
			'persen_ipk350' => 'Persen Ipk350',
