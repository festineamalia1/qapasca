...
class TenagaKependidikan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, jenis_tenaga, jumS3, jumS2, jumS1, jumD4, jumD3, jumD2, jumD1, jumSMA, jumSMK, unit_kerja, upaya_peningkatan_kompetensi, sumber_data', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'F_pandangan_fakultas' => 'F Pandangan Fakultas',
