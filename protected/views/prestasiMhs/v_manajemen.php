...
$this->breadcrumbs=array(
	'Manajemen Data Prestasi Mahasiswa',
);
?>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/prestasimhs/admin" class="c_tab" data-toggle="tab">Prestasi Mahasiswa</a></li>
