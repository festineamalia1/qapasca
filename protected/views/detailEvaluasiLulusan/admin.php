...
$this->breadcrumbs=array(
	'Tanggapan Pihak Pengguna Lulusan'=>array('index'),
	'Manajemen',
);
...
$('.search-form form').submit(function(){
	$('#detail-evaluasi-lulusan-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Managjemen Data Tanggapan Pihak Pengguna Lulusan</h1>
<?
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'detail-evaluasi-lulusan-grid',
