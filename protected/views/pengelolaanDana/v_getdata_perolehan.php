...
<?php
	// $model=new VisiMisi;
?>
<h1>Perolehan dan Alokasi Dana</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_perolehan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_perolehan"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_perolehan").click(function()
  	{
  		var dataserialized = $('#form_perolehan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdataperolehan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_perolehan").trigger('click');
