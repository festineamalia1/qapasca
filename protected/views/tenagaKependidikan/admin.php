...
$this->breadcrumbs=array(
	'Tenaga Kependidikans'=>array('index'),
	'Manajemen Data',
);
...
$('.search-form form').submit(function(){
	$('#tenaga-kependidikan-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manajemen Data Tenaga Kependidikan</h1>
<?
