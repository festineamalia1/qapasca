...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'mekanisme-penyusunan-mk-form',
...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'penjelasan_penyusunan'); ?>
		<?php //echo $form->textArea($model,'penjelasan_penyusunan',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'penjelasan_penyusunan'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'penjelasan_penyusunan',
                'editorTemplate'=>'full',
