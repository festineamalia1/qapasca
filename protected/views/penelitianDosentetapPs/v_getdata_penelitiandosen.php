							...
							<form class="form-inline" method="post" id="form_judul">
							   <label class="control-label" for="">Jurusan</label>
							    ...
							    <label class="control-label" for="">Tahun</label>
							      ...
							      <button type="button" class="btn btn-primary getdata_judul"><i class="icon-arrow-right icon-white"></i> Proses</button>
							</form>
						</div>
					</div>
					<!-- END -->
							...
							<form class="form-inline" method="post" id="form_karya">
							   <label class="control-label" for="">Jurusan</label>
							    ...
							    <label class="control-label" for="">Tahun</label>
							      ...
							      <button type="button" class="btn btn-primary getdata_karya"><i class="icon-arrow-right icon-white"></i> Proses</button>
							</form>
						</div>
					</div>
				</div>
