...
<!-- tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'sumber_pembiayaan',array('sendiri'=>'Sendiri','pt'=>'PT yang bersangkutan','depdiknas'=>'Depdiknas','luar_depdiknas'=>'Institusi dalam negeri luar depdiknas','luar_negeri'=>'Institusi Luar Negeri'),array('prompt' => 'Pilih Sumber Pembiayaan')); ?>
	</div>
<!-- end tambahan -->
	<!-- <div class="row">
		<?php //echo $form->labelEx($model,'sumber_pembiayaan'); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'detail_sumber_biaya'); ?>
		<?php echo $form->textField($model,'detail_sumber_biaya',array('size'=>40,'maxlength'=>40)); ?>
		<?php echo $form->error($model,'detail_sumber_biaya'); ?>
	</div>
