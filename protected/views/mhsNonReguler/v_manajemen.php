...
$this->breadcrumbs=array(
	'Manajemen Data Mahasiswa Non Reguler',
);
?>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/mhsnonreguler/admin" class="b_tab" data-toggle="tab">Mahasiswa Non Reguler</a></li>
