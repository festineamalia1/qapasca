...
<?php
	// $model=new VisiMisi;
?>
<h1>Upaya Peningkatan Suasana Akademik</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_peningkatan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_peningkatan"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_peningkatan").click(function()
  	{
  		var dataserialized = $('#form_peningkatan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdatapeningkatan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_peningkatan").trigger('click');
