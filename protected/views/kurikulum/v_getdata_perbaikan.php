...
<?php
	// $model=new VisiMisi;
?>
<h1>Upaya Perbaikan Pembelajaran</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_perbaikan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdata_perbaikan"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_perbaikan").click(function()
  	{
  		var dataserialized = $('#form_perbaikan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdataperbaikan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_perbaikan").trigger('click');
