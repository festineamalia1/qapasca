...
<div class="row-fluid">
	<div class="span12">
		<form class="form-inline" method="post" id="form_prestasi">		    
		    <label class="control-label" for="">Prestasi Mahasiswa dan Dosen</label>
		      <select class="input-small" name="id_administrasi" id="tahun">
		          <option value="all">Semua</option>
		          <option value="reg">Mahasiswa Reguler</option>
		          <option value="nonreg">Mahasiswa Non Reguler</option>
		          <option value="dosen">Dosen</option>
		      </select>
		    
		    <button type="button" class="btn btn-primary getdata_prestasi"><i class="icon-arrow-right icon-white"></i> Proses</button>
		</form>
		...
		<div id="data_mhs_reg" class="data">	
			<?php $this->renderPartial('pages/v_gr_prestasi', array()); ?>
		</div>
	</div>
</div>
<hr>
