...
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_jurusan">
		    ...
		    <button type="button" class="btn btn-primary getdata_capaiandosen"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdata_capaiandosen").click(function()
  	{
  		var dataserialized = $('#form_jurusan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"sentdata_capaiandosen",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_capaiandosen").trigger('click');
